...
class InvoiceController extends Controller
{
    ...
    {
        $invoice = Invoice::find($id); //QUERY KEDATABASE UNTUK MENGAMBIL DATA BERDASARKAN ID
        $invoice->delete(); // MENGHAPUS DATA YANG ADA DIDATABASE
        return redirect('/invoice')->with(['success' => '</strong> Invoice </strong> Dihapus']); // DIARAHKAN KEMBALI KEHALAMAN /product
    }
